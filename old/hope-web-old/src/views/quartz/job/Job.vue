    ...
    <div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operations" slot-scope="text, record">
          <a v-hasPermission="'job:update'" @click="edit(record)" title="">修改&ensp;</a>
          <span  v-hasAnyPermission="['job:run','job:pause','job:resume']">
            <a v-hasPermission="['job:run']" href="javascript:void(0)" @click="runJob(record)">立即执行&ensp;</a>
            <a v-hasPermission="['job:pause']" v-if="record.status === '0'" href="javascript:void(0)" @click="pauseJob(record)">暂停任务&ensp;</a>
            <a v-hasPermission="['job:resume']" v-if="record.status === '1'" href="javascript:void(0)" @click="resumeJob(record)">恢复任务&ensp;</a>
          </span>
          &nbsp;
          ...
          <a v-hasNoPermission="['job:update','job:run','job:pause','job:resume']">无权限</a>
        </template>
      </a-table>
    </div>
    <!-- 新增任务 -->
