...
public class TestController extends BaseController {
    ...
    public String httpTest() throws IOException {
        ...
        return wechatAlertService.sendAsText(wechatKey,"123");
    }


    @GetMapping("/transTest/{targetLang}/{text}")
    public String transTest(@PathVariable String targetLang, @PathVariable String text) throws IOException {
        return transService.azureTrans(text,targetLang);
    }
    ...
    public String wechatTest() throws IOException {
        ...
        content.addProperty("content","hell");
        jsonObject.add("text",content);
        return okHttpClientUtils.postJson("https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=e0af3b63-9a31-41fd-a99a-a06d1eae38fa",jsonObject.toString());
    }
